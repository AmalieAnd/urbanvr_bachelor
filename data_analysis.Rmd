...
---
                                                   ...
                                                   Bachelor project: Analysis of 'TITLE' 
...
#"bayesplot", "RColorBrewer", "cowplot"
...
# direc w/labs
this <- brms::marginal_effects(direc1)
plot(this, plot = F)[[1]] +
  scale_color_brewer(type = "qual", palette = "Set1") +
  scale_fill_brewer(type = "qual", palette = "Set1") +
  labs(title = "Marginal effects of Model 1.1 (Direction) ", x = "Condition", y = "Count of direction words") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))

that <- brms::marginal_effects(colour1)
plot(that, plot = F)[[1]] +
  scale_color_brewer(type = "qual", palette = "Set1") +
  scale_fill_brewer(type = "qual", palette = "Set1") +
  labs(title = "Marginal effects of Model 1.3 (Colour) ", x = "Condition", y = "Count of colour words") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```

```{r pred vs actual plots}
#(not used)
